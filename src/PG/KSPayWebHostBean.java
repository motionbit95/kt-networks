...
public class KSPayWebHostBean
{
	...
	public KSPayWebHostBean(String _payKey,String _amount) {
		this.payKey		= _payKey;
    ...
    public String send_url()
    {
		...
		try {
			String post_msg = sb.append("sndCommConId=").append(this.payKey).append("&sndActionType=").append(this.mtype).append("&sndAmount=").append(this.payAmt).append("&sndRpyParams=").append(URLEncoder.encode(this.rparams,"euc-kr")).toString();
